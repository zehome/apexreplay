...
html="""
    <tbody>
        <tr data-id="r0" class="head" data-pos="0">
            ...
            <td data-id="c3" data-type="rk" data-pr="1">Cla</td>
            <td data-id="c4" data-type="no" data-pr="1">Kart</td>
            <td data-id="c5" data-type="" data-pr="6" data-width="21">Colore</td>
            <td data-id="c6" data-type="" data-pr="6" data-width="5" data-min="3">Club</td>
            <td data-id="c7" data-type="dr" data-pr="1" data-width="24" data-min="16">Pilota</td>
            <td data-id="c8" data-type="llp" data-pr="2" data-width="17" data-min="7">Ultimo T.</td>
            <td data-id="c9" data-type="gap" data-pr="1" data-width="17" data-min="8">Distacco</td><td data-id="c10" data-type="blp" data-pr="6" data-width="14" data-min="7">M.giro</td>
        </tr>
        <tr data-id="r1" data-pos="1">
            <td data-id="r1c1" class="gs"></td>
            <td data-id="r1c2" class="sr"></td>
            <td class="rk"><div><p data-id="r1c3" class="">1</p></div></td>
            <td class="no"><div data-id="r1c4" class="no2">7</div></td>
            <td data-id="r1c5" class="in"></td>
            <td data-id="r1c6" class="in"></td>
            <td data-id="r1c7" class="dr">ELIA</td>
            <td data-id="r1c8" class="tb">48.146</td>
            <td data-id="r1c9" class="in">Giro 3</td>
            <td data-id="r1c10" class="in">48.146</td>
        </tr>
        <tr data-id="r2" data-pos="3"><td data-id="r2c1" class="gf"></td>
            <td data-id="r2c2" class="sr"></td>
            <td class="rk"><div><p data-id="r2c3" class="">3</p></div></td>
            <td class="no"><div data-id="r2c4" class="no2">20</div></td>
            <td data-id="r2c5" class="in"></td>
            <td data-id="r2c6" class="in"></td>
            <td data-id="r2c7" class="dr">NICOLAS</td>
            <td data-id="r2c8" class="ti">49.988</td>
            <td data-id="r2c9" class="ib">5.974</td>
            <td data-id="r2c10" class="in">49.988</td>
        </tr>
        <tr data-id="r3" data-pos="2"><td data-id="r3c1" class="gs"></td>
            <td data-id="r3c2" class="sr"></td>
            <td class="rk"><div><p data-id="r3c3" class="">2</p></div></td>
            <td class="no"><div data-id="r3c4" class="no2">42</div></td>
            <td data-id="r3c5" class="in"></td>
            <td data-id="r3c6" class="in"></td>
            <td data-id="r3c7" class="dr">TATIANO</td>
            <td data-id="r3c8" class="ti">48.245</td>
            <td data-id="r3c9" class="ib">2.786</td>
            <td data-id="r3c10" class="in">48.245</td>
            </tr><tr data-id="r4" data-pos="7"><td data-id="r4c1" class="gl"></td>
            <td data-id="r4c2" class="sr"></td>
            <td class="rk"><div><p data-id="r4c3" class="">7</p></div></td>
            <td class="no"><div data-id="r4c4" class="no2">12</div></td>
            <td data-id="r4c5" class="in"></td>
            <td data-id="r4c6" class="in"></td>
            <td data-id="r4c7" class="dr">SAM</td>
            <td data-id="r4c8" class="ti">49.272</td>
            <td data-id="r4c9" class="ib">16.658</td>
            <td data-id="r4c10" class="in">49.272</td>
            </tr><tr data-id="r5" data-pos="6"><td data-id="r5c1" class="gf"></td>
            <td data-id="r5c2" class="sr"></td>
            <td class="rk"><div><p data-id="r5c3" class="">6</p></div></td>
            <td class="no"><div data-id="r5c4" class="no2">29</div></td>
            <td data-id="r5c5" class="in"></td>
            <td data-id="r5c6" class="in"></td>
            <td data-id="r5c7" class="dr">MATTEO</td>
            <td data-id="r5c8" class="ti">51.369</td>
            <td data-id="r5c9" class="ib">16.222</td>
            <td data-id="r5c10" class="in">51.369</td></tr><tr data-id="r6" data-pos="9"><td data-id="r6c1" class="gs">
...
# {'position': '1', 'number': '7', 'name': 'ELIA', 'last_lap': '48.146', 'best_lap': '48.146'}
def parse_table(html):
    root = lxml.html.fromstring(html)
    headers = root.xpath("//tbody/tr[@class='head']/td[@data-type!='']")
    retmap = {}
    rettable = []
    for row in headers:
        try:
            retmap[datatypemapping[row.get("data-type")]] = row.get("data-id")
        except KeyError:
            pass
    for row in root.xpath("//tbody/tr[not(@class='head')]"):
        if row.get("class") == "head":
            continue
        rn = row.get("data-id")
        if not rn:
            continue
        pilotmap = {}
        for k, colid in retmap.items():
            dataid = f"{rn}{colid}"
            element = row.xpath(f".//*[@data-id='{dataid}']")
            # print(f"dataid: {dataid} ({k}): {element}")
            # breakpoint()
            if element:
                elementtext = element[0].text.strip() if element[0].text else ''
                if elementtext:
                    pilotmap[k] = type_mapping.get(k, str)(elementtext)
            if pilotmap:
                pilotmap["id"] = rn
                rettable.append(pilotmap)
    return retmap, rettable
